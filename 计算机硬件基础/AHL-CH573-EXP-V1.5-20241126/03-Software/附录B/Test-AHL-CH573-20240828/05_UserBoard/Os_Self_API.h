...
//中断保护函数
#define rt_interrupt_leave ((void (*)(void))(component_fun[64]))
#define rt_interrupt_enter ((void (*)(void))(component_fun[65]))

#define rt_tick_increase ((void (*)(void))(component_fun[62]))
