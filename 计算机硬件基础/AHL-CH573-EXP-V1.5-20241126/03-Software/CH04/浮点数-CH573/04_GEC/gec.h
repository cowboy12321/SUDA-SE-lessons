...
//【变动】GEC基本信息==================================================
#define GEC_USER_SECTOR_START    (18)   /*【0启动】2/2处，0-0启动，31-从BIOS启动*/
#define GEC_COMPONENT_LST_START  (16)   //构件库函数列表开始扇区号
// #define BIOS_SYSTICK_IRQn        (12+1)
// #define BIOS_SW_IRQn             (14+1)
#define BIOS_UART_UPDATE_IRQn    (28)   //BIOS程序写入串口的中断号
...
//【固定】存储更新程序起始扇区、结束扇区
#define GEC_SAVE_USER_SECTOR_START    (38)
#define GEC_SAVE_USER_SECTOR_END      (53)

#define GEC_USERBASE         (MCU_FLASH_ADDR_START + GEC_USER_SECTOR_START*MCU_SECTORSIZE)

//【固定】构件库函数指针和系统功能函数声明===========================================
void **  component_fun;
#define DC_flash_erase ((uint8_t (*)(uint16_t sect))(component_fun[26]))
void  Vectors_Init();

void SYS_ResetExecute( void );
#define NVIC_SystemReset SYS_ResetExecute       //系统复位函数
