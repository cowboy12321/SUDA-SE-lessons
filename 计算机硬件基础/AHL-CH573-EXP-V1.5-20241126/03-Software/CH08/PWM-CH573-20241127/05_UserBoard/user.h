...
//PWM通道号宏定义
// #define PWM_USER (PTB_NUM|10)     //PWM_TIM1(PB10)  GEC_27
...
#define PWM_USER   PWM_TIM1
static char PWM_USER_NAME[] = "定时器PWM通道1";
static char PWM_USER_PIN[] = "PB10";            //GEC_27
#define INCAP_USER (PTB_NUM|10)
static char INCAP_USER_PIN[] = "PB10";          //GEC_28
